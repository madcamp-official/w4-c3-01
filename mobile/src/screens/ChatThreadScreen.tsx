// Placeholder for Phase 3 — real chat thread comes then.
...
export default function ChatThreadScreen({ navigation }: Props) {
  return (
    <SafeAreaView style={common.screen} edges={['top', 'bottom']}>
      ...
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
        <Text style={common.title}>채팅방</Text>
        <Text style={common.subtitle}>Phase 3에서 구현됩니다.</Text>
      </View>
    </SafeAreaView>
  );
}
