// Icon set — path data matches week4_1/ALine.dc.html exactly (the approved
// v2 design; 'x'/'link'/'message-square' aren't covered by that mockup so
// they keep their previous shape, just restyled). `sketchy` defaults to
// false (the v2 design dropped the hand-drawn double-stroke jitter look) but
// the option is kept in case a caller wants it back for a specific icon.
